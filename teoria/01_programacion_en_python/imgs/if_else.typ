...
#set page(width: 150mm, height: 195mm, margin: 8mm)
...
#fletcher.diagram(
  ...
  node((0pt, 450pt), [Inicio], name: <inicio>, width: 38mm, height: 20mm, fill: terminal-fill, stroke: terminal-stroke),
  edge(<inicio.south>, <condicion.north>, "-|>"),

  node((0pt, 300pt), [Condición], name: <condicion>, width: 50mm, height: 25mm, fill: condition-fill, stroke: condition-stroke, shape: ellipse),
  node((240pt, 300pt), [Ejecutar\ bloque if], name: <bloque-if>, width: 48mm, height: 22mm, fill: block-fill, stroke: block-stroke),
  ...
  edge(<condicion.south>, <bloque-else.north>, "-|>", edge-label("False"), label-side: right),
